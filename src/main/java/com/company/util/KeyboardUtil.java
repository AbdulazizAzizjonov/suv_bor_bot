...
public class KeyboardUtil {
    ...
    public static ReplyKeyboard changeLanguage () {
        KeyboardButton languageUz = new KeyboardButton("");
        KeyboardButton languageRu = new KeyboardButton("");
        KeyboardRow row1 = getRow(languageUz);
        KeyboardRow row2 = getRow(languageRu);
